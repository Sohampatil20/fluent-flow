...
import { useRouter } from "next/router";
 // Import the capitalized component name
  ...
  interface WriteInEnglishProblem extends Basehindiproblem {
...
type hindiProblems = Select1Of3Problem | WriteInEnglishProblem;

const hindiProblem1: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question: `इनमें से "सेब" कौन सा है?`,
  answers: [
     { icon: <AppleSvg />, name: "सेब" },
      { icon: <BoySvg />, name: "लड़का" },
      { icon: <WomanSvg />, name: "महिला" },  
],
  correctAnswer: 0,
};
  

  const hindiProblem2: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `इनमें से "कुत्ता" कौन सा है?`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/corgi.png" alt="Corgi" />, name: "कुत्ता" },
      { icon: <img src="https://img.icons8.com/color/100/fat-cat.png" alt="बिल्ली" />, name: "बिल्ली" },
      { icon: <img src="https://img.icons8.com/color/100/bread.png" alt="रोटी" />, name: "रोटी" },
    ],
    correctAnswer: 0,
  };
  const hindiProblem3: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: 'इनमें से "गाय" कौन सी है?',
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/cow.png" alt="गाय" />, name: "गाय" },
      { icon: <img src="https://img.icons8.com/color/100/horse.png" alt="घोड़ा" />, name: "घोड़ा" },
      { icon: <img src="https://img.icons8.com/color/100/sheep.png" alt="भेड़" />, name: "भेड़" },
    ],
    correctAnswer: 0,
  };
  
  const hindiProblem4: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: 'इनमें से "पेड़" कौन सा है?',
    answers: [
      { icon: <img src="https://img.icons8.com/doodle/100/tree--v1.png" alt="पेड़" />, name: "पेड़" },
      { icon: <img src="https://img.icons8.com/color/100/grass.png" alt="घास" />, name: "घास" },
      { icon: <img src="https://img.icons8.com/color/100/flower.png" alt="फूल" />, name: "फूल" },
    ],
    correctAnswer: 0,
  };
  
  const hindiProblem5: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: 'इनमें से "सूरज" कौन सा है?',
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/sun.png" alt="सूरज" />, name: "सूरज" },
      { icon: <img src="https://img.icons8.com/color/100/moon.png" alt="चाँद" />, name: "चाँद" },
      { icon: <img src="https://img.icons8.com/color/100/star.png" alt="तारा" />, name: "तारा" },
    ],
    correctAnswer: 0,
  };
  
  const hindiProblem6: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question:' इनमें से "बिल्ली" कौन सी है?',
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/fat-cat.png" alt="बिल्ली" />, name: "बिल्ली" },
      { icon: <img src="https://img.icons8.com/color/100/corgi.png" alt="कुत्ता" />, name: "कुत्ता" },
      { icon: <img src="https://img.icons8.com/color/100/rabbit.png" alt="खरगोश" />, name: "खरगोश" },
    ],
    correctAnswer: 0,
  };
  
  const hindiProblem7: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: 'इनमें से "कार" कौन सी है?',
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/car.png" alt="कार" />, name: "कार" },
      { icon: <img src="https://img.icons8.com/color/100/bicycle.png" alt="साइकिल" />, name: "साइकिल" },
      { icon: <img src="https://img.icons8.com/color/100/bus.png" alt="बस" />, name: "बस" },
    ],
    correctAnswer: 0,
  };
  const hindiProblem8: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "वह स्कूल जा रहा है", // "He is going to school"
    answerTiles: ["he", "she", "school", "going", "to", "it", "is", "they"], // English answer tiles
    correctAnswer: [0, 6, 3, 4, 2] // Correct order: "He is going to school"
  };
  
  const hindiProblem9: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "मैं खाना खा रहा हूँ", // "I am eating food"
    answerTiles: ["I", "food", "eating", "am", "drink", "we", "you"], // English answer tiles
    correctAnswer: [0, 3, 2, 1] // Correct order: "I am eating food"
  };
  
  const hindiProblem10: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "गाड़ी सड़क पर है", // "The car is on the road"
    answerTiles: ["the", "car", "road", "is", "on", "at", "park", "truck"], // English answer tiles
    correctAnswer: [0, 1, 3, 4, 2] // Correct order: "The car is on the road"
  };
  
  const hindiProblem11: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "यह किताब मेरी है", // "This book is mine"
    answerTiles: ["this", "book", "mine", "is", "her", "his", "a"], // English answer tiles
    correctAnswer: [0, 1, 3, 2] // Correct order: "This book is mine"
  };
  
  const hindiProblem12: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "बच्चे पार्क में खेल रहे हैं", // "The children are playing in the park"
    answerTiles: ["the", "children", "playing", "are", "in", "park", "school", "at"], // English answer tiles
    correctAnswer: [1, 3, 2, 4, 5, 0] // Correct order: "The children are playing in the park"
  };
  
  const hindiProblem13: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "उसका नाम अमित है", // "His name is Amit"
    answerTiles: ["his", "name", "is", "Amit", "her", "was", "your"], // English answer tiles
    correctAnswer: [0, 1, 2, 3] // Correct order: "His name is Amit"
  };
  
  const hindiProblem14: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "मेरे पास एक कुत्ता है", // "I have a dog"
    answerTiles: ["I", "have", "a", "dog", "cat", "own", "pet"], // English answer tiles
    correctAnswer: [0, 1, 2, 3] // Correct order: "I have a dog"
  };
  
  const hindiProblem15: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "तुम कहाँ जा रहे हो", // "Where are you going?"
    answerTiles: ["where", "are", "you", "going", "staying", "to", "we"], // English answer tiles
    correctAnswer: [0, 1, 2, 3] // Correct order: "Where are you going?"
  };
  
  const hindiProblem16: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "मुझे चाय पसंद है", // "I like tea"
    answerTiles: ["I", "like", "tea", "water", "coffee", "milk"], // English answer tiles
    correctAnswer: [0, 1, 2] // Correct order: "I like tea"
  };
  
  
 
  
  const hindiProblems: Basehindiproblem[] = [
    hindiProblem1,
    hindiProblem2,
    hindiProblem3,
    hindiProblem4,
...
type hindiproblemsArray = readonly (Select1Of3Problem | WriteInEnglishProblem)[];

// Cast the hindiproblem array to the correct type
...
const getRandomQuestions = (problems: Basehindiproblem[], count: number): Basehindiproblem[] => {
...
const hindiLessons: NextPage = () => {
    const router = useRouter();
  
    const [hindiproblemIndex, setHindiproblemIndex] = useState(0); // Renamed to clarify it's an index
    ...
    const [, setSelectedQuestions] = useState<Basehindiproblem[]>([]);
    ...
    useEffect(() => {
      const questions = getRandomQuestions(hindiProblems, 3); // Get 2 random questions
    ...
    const problem = hindiProblems[hindiproblemIndex] ?? hindiProblem1;
  ...
  const onFinish = () => {
    ...
    setHindiproblemIndex((x) => (x + 1) % hindiProblems.length);
