...
import { useRouter } from "next/router";
 // Import the capitalized component name
  ...
  interface WriteInEnglishProblem extends Basejapaneseproblem {
...
type japaneseProblems = Select1Of3Problem | WriteInEnglishProblem;

const japaneseProblem1: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `これらの中で「リンゴ」はどれですか？`,
    answers: [
      { icon: <AppleSvg />, name: "リンゴ" },
      { icon: <BoySvg />, name: "男の子" },
      { icon: <WomanSvg />, name: "女性" },
    ],
    correctAnswer: 0,
  };
  
  const japaneseProblem2: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `これらの中で「犬」はどれですか？`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/corgi.png" alt="Corgi" />, name: "犬" },
      { icon: <img src="https://img.icons8.com/color/100/fat-cat.png" alt="猫" />, name: "猫" },
      { icon: <img src="https://img.icons8.com/color/100/bread.png" alt="パン" />, name: "パン" },
    ],
    correctAnswer: 0,
  };
  
  const japaneseProblem3: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `これらの中で「牛」はどれですか？`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/cow.png" alt="牛" />, name: "牛" },
      { icon: <img src="https://img.icons8.com/color/100/horse.png" alt="馬" />, name: "馬" },
      { icon: <img src="https://img.icons8.com/color/100/sheep.png" alt="羊" />, name: "羊" },
    ],
    correctAnswer: 0,
  };
  
  const japaneseProblem4: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `これらの中で「木」はどれですか？`,
    answers: [
      { icon: <img src="https://img.icons8.com/doodle/100/tree--v1.png" alt="木" />, name: "木" },
      { icon: <img src="https://img.icons8.com/color/100/grass.png" alt="草" />, name: "草" },
      { icon: <img src="https://img.icons8.com/color/100/flower.png" alt="花" />, name: "花" },
    ],
    correctAnswer: 0,
  };
  
  const japaneseProblem5: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `これらの中で「太陽」はどれですか？`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/sun.png" alt="太陽" />, name: "太陽" },
      { icon: <img src="https://img.icons8.com/color/100/moon.png" alt="月" />, name: "月" },
      { icon: <img src="https://img.icons8.com/color/100/star.png" alt="星" />, name: "星" },
    ],
    correctAnswer: 0,
  };
  
  const japaneseProblem6: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `これらの中で「猫」はどれですか？`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/fat-cat.png" alt="猫" />, name: "猫" },
      { icon: <img src="https://img.icons8.com/color/100/corgi.png" alt="犬" />, name: "犬" },
      { icon: <img src="https://img.icons8.com/color/100/rabbit.png" alt="ウサギ" />, name: "ウサギ" },
    ],
    correctAnswer: 0,
  };
  
  const japaneseProblem7: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `これらの中で「車」はどれですか？`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/car.png" alt="車" />, name: "車" },
      { icon: <img src="https://img.icons8.com/color/100/bicycle.png" alt="自転車" />, name: "自転車" },
      { icon: <img src="https://img.icons8.com/color/100/bus.png" alt="バス" />, name: "バス" },
    ],
    correctAnswer: 0,
  };
  
  const japaneseProblem8: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "彼は学校に行っています", // "He is going to school"
    answerTiles: ["he", "she", "school", "going", "to", "it", "is", "they"],
    correctAnswer: [0, 6, 3, 4, 2],
  };
  
  const japaneseProblem9: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "私は食べ物を食べています", // "I am eating food"
    answerTiles: ["I", "food", "eating", "am", "drink", "we", "you"],
    correctAnswer: [0, 3, 2, 1],
  };
  
  const japaneseProblem10: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "車は道の上にあります", // "The car is on the road"
    answerTiles: ["the", "car", "road", "is", "on", "at", "park", "truck"],
    correctAnswer: [0, 1, 3, 4, 2],
  };
  
  const japaneseProblem11: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "この本は私のものです", // "This book is mine"
    answerTiles: ["this", "book", "mine", "is", "her", "his", "a"],
    correctAnswer: [0, 1, 3, 2],
  };
  
  const japaneseProblem12: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "子供たちは公園で遊んでいます", // "The children are playing in the park"
    answerTiles: ["the", "children", "playing", "are", "in", "park", "school", "at"],
    correctAnswer: [1, 3, 2, 4, 5, 0],
  };
  
  const japaneseProblem13: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "彼の名前はアミットです", // "His name is Amit"
    answerTiles: ["his", "name", "is", "Amit", "her", "was", "your"],
    correctAnswer: [0, 1, 2, 3],
  };
  
  const japaneseProblem14: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "私は犬を飼っています", // "I have a dog"
    answerTiles: ["I", "have", "a", "dog", "cat", "own", "pet"],
    correctAnswer: [0, 1, 2, 3],
  };
  
  const japaneseProblem15: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "どこへ行くのですか", // "Where are you going?"
    answerTiles: ["where", "are", "you", "going", "staying", "to", "we"],
    correctAnswer: [0, 1, 2, 3],
  };
  
  const japaneseProblem16: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "私はお茶が好きです", // "I like tea"
    answerTiles: ["I", "like", "tea", "water", "coffee", "milk"],
    correctAnswer: [0, 1, 2],
  };
  
  const japaneseProblems: Basejapaneseproblem[] = [
    japaneseProblem1,
    japaneseProblem2,
    japaneseProblem3,
    japaneseProblem4,
...
type japaneseproblemsArray = readonly (Select1Of3Problem | WriteInEnglishProblem)[];

// Cast the japaneseproblem array to the correct type
...
const getRandomQuestions = (problems: Basejapaneseproblem[], count: number): Basejapaneseproblem[] => {
...
const japaneseLessons: NextPage = () => {
    const router = useRouter();
  
    const [japaneseproblemIndex, setjapaneseproblemIndex] = useState(0); // Renamed to clarify it's an index
    ...
    const [, setSelectedQuestions] = useState<Basejapaneseproblem[]>([]);
    ...
    useEffect(() => {
      const questions = getRandomQuestions(japaneseProblems, 3); // Get 2 random questions
    ...
    const problem = japaneseProblems[japaneseproblemIndex] ?? japaneseProblem1;
  ...
  const onFinish = () => {
    ...
    setjapaneseproblemIndex((x) => (x + 1) % japaneseProblems.length);
