...
const TileTooltip = ({
  ...
  // New state for lesson selection
  ...
  const handleLessonSelect = (lesson: string) => {
    ...
    localStorage.setItem("selectedLesson", lesson); // Debugging line
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Buttons to choose the lesson dynamically */}
        {status === "ACTIVE" && (
  <div className="flex space-x-2 mb-2">
    ...
    <button
      onClick={() => handleLessonSelect("/hindilessons")}
      className="p-0 bg-green-500 text-white rounded opacity-20 text-xs border-none"
    >
      Hindi
    </button>
    <button
      onClick={() => handleLessonSelect("/japaneselessons")}
      className="p-0 bg-green-500 text-white rounded opacity-20 text-xs border-none"
    >
      japanese
    </button>
    ...
    <button
      onClick={() => handleLessonSelect("/germanlessons")}
      className="p-0 bg-green-500 text-white rounded opacity-20 text-xs border-none"
    >
      german
    </button>
...
{status === "ACTIVE" ? (
    <Link
      href={selectedLesson} // Dynamically chosen lesson path
      className={[
        "flex w-full items-center justify-center rounded-xl border-b-4 border-gray-200 bg-white p-2 text-sm uppercase",
        activeTextColor,
      ].join(" ")}
    >
      Start +3 XP
    ...
    <Link
      href={selectedLesson} // Use selectedLesson for Practice +2 XP as well
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between gap-4 p-4">
        ...
        <Link
          href={'https://www.kanopystreaming.com/sites/default/files/learningspanish.pdf'}
          className={[
