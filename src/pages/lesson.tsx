...
interface Select1Of3Problem extends BaseLessonProblem {
  readonly type: "SELECT_1_OF_3";
  readonly answers: readonly { icon: React.JSX.Element; name: string }[];
  readonly correctAnswer: number;
}

interface WriteInEnglishProblem extends BaseLessonProblem {
  readonly type: "WRITE_IN_ENGLISH";
  readonly answerTiles: string[];
  readonly correctAnswer: number[];
}

// Create a union type for all possible lesson problems
type LessonProblem = Select1Of3Problem | WriteInEnglishProblem;

// Define the lesson problems
const lessonProblem1: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
...
const lessonProblem2: WriteInEnglishProblem = {
...
const lessonProblem3: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question: `Which one of these is "the dog"?`,
  answers: [
    { icon:<img src= "https://img.icons8.com/color/100/corgi.png"/>, name: "el perro" },
    { icon: <img src="https://img.icons8.com/color/100/fat-cat.png" alt="Cat" />, name: "el gato" },
    { icon: <img src="https://img.icons8.com/color/100/bread.png" alt="Bread" />, name: "el pan" },
  ],
  correctAnswer: 0,
};

const lessonProblem4: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "La casa",
  answerTiles: ["house", "tree", "car", "dog", "cat"],
  correctAnswer: [0],
};

const lessonProblem5: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question: `Which one of these is "the table"?`,
  answers: [
    { icon: <img src="https://img.icons8.com/matisse/100/table.png" alt="Table" />, name: "la mesa" },
    { icon: <img src="https://img.icons8.com/doodle/100/chair--v1.png" alt="Chair" />, name: "la silla" },
    { icon: <img src="https://img.icons8.com/doodle/100/boy.png" alt="Boy" />, name: "el niño" },
  ],
  correctAnswer: 0,
};

const lessonProblem6: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "La comida",
  answerTiles: ["food", "water", "milk", "bread", "sugar"],
  correctAnswer: [0],
};

const lessonProblem7: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question: `Which one of these is "the cat"?`,
  answers: [
    { icon: <img src="https://img.icons8.com/color/100/fat-cat.png" alt="Cat" />, name: "el gato" },
    { icon:  <img src= "https://img.icons8.com/doodle/100/boy.png" alt="boy"/>, name: "el niño"},
    { icon: <img src="https://img.icons8.com/matisse/100/strawberry.png" alt="Fruit" />, name: "la fruta" },
  ],
  correctAnswer: 0,
};

const lessonProblem8: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "El libro",
  answerTiles: ["book", "pen", "table", "chair", "paper"],
  correctAnswer: [0],
};
const lessonProblem9: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question: 'Which one of these is "the car"?',
  answers: [
    { icon: <img src="https://img.icons8.com/color/100/car.png" alt="Car" />, name: "el coche" },
    { icon: <img src="https://img.icons8.com/color/100/bus.png" alt="Bus" />, name: "el autobús" },
    { icon: <img src="https://img.icons8.com/color/100/bike.png" alt="Bike" />, name: "la bicicleta" },
  ],
  correctAnswer: 0,
};

const lessonProblem10: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "El agua",
  answerTiles: ["house", "water", "table", "I", "The", "boy"],
  correctAnswer: [4, 1],
};

const lessonProblem11: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question:' Which one of these is "the book"?',
  answers: [
    { icon: <img src="https://img.icons8.com/color/100/book.png" alt="Book" />, name: "el libro" },
    { icon: <img src="https://img.icons8.com/color/100/pencil.png" alt="Pencil" />, name: "el lápiz" },
    { icon: <img src="https://img.icons8.com/color/100/backpack.png" alt="Backpack" />, name: "la mochila" },
  ],
  correctAnswer: 0,
};

const lessonProblem12: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "La mesa",
  answerTiles: ["chair", "water", "table", "dog", "cat"],
  correctAnswer: [2],
};

const lessonProblem13: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question: 'Which one of these is "the chair"?',
  answers: [
    { icon: <img src="https://img.icons8.com/color/100/chair.png" alt="Chair" />, name: "la silla" },
    { icon: <img src="https://img.icons8.com/color/100/sofa.png" alt="Sofa" />, name: "el sofá" },
    { icon: <img src="https://img.icons8.com/color/100/table.png" alt="Table" />, name: "la mesa" },
  ],
  correctAnswer: 0,
};

const lessonProblem14: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "La leche",
  answerTiles: ["milk", "water", "bread", "sugar", "juice"],
  correctAnswer: [0],
};

const lessonProblem15: Select1Of3Problem = {
  type: "SELECT_1_OF_3",
  question: 'Which one of these is "the tree"?',
  answers: [
    { icon: <img src="https://img.icons8.com/emoji/96/deciduous-tree-emoji.png" alt="Tree" />, name: "el árbol" },
    { icon: <img src="https://img.icons8.com/color/100/flower.png" alt="Flower" />, name: "la flor" },
    { icon: <img src="https://img.icons8.com/color/100/cloud.png" alt="Cloud" />, name: "la nube" },
  ],
  correctAnswer: 0,
};

const lessonProblem16: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "La flor",
  answerTiles: ["flower", "pen", "chair", "table", "paper"],
  correctAnswer: [0],
};
const lessonProblem17: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "La universidad",
  answerTiles: ["school", "college", "university", "building", "library"],
  correctAnswer: [2],
};

const lessonProblem18: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "El desayuno",
  answerTiles: ["dinner", "breakfast", "lunch", "snack", "meal"],
  correctAnswer: [1],
};

const lessonProblem19: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "El libro está en la mesa",
  answerTiles: ["table", "book", "pen", "the", "is", "on"],
  correctAnswer: [3, 1, 4, 5, 0] // Correct order: "The book is on the table"
};


const lessonProblem20: WriteInEnglishProblem = {
  type: "WRITE_IN_ENGLISH",
  question: "La familia vive en la casa",
  answerTiles: ["the", "family", "in", "lives", "house", "city"],
  correctAnswer: [1, 3, 2, 0, 4],
};
// Add these problems to your lesson problems array
...
type LessonProblemsArray = readonly (Select1Of3Problem | WriteInEnglishProblem)[];

// Cast the lessonProblems array to the correct type
const lessonProblemsArray: LessonProblemsArray = lessonProblems as LessonProblemsArray;
...
const getRandomQuestions = (problems: LessonProblem[], count: number): LessonProblem[] => {
...
const Lesson: NextPage = () => {
  ...
  const [, setSelectedQuestions] = useState<LessonProblem[]>([]);
  ...
  useEffect(() => {
    const questions = getRandomQuestions(lessonProblems, 3); // Get 2 random questions
...
function setProblems(hindiProblems: LessonProblem[]) {
