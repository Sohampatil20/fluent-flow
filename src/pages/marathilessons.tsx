...
import { useRouter } from "next/router";
 // Import the capitalized component name
  ...
  interface WriteInEnglishProblem extends Basemarathiproblem {
...
type marathiProblems = Select1Of3Problem | WriteInEnglishProblem;

const marathiProblem1: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `यापैकी "सफरचंद" कोणते आहे?`,
    answers: [
      { icon: <AppleSvg />, name: "सफरचंद" },
      { icon: <BoySvg />, name: "मुलगा" },
      { icon: <WomanSvg />, name: "स्त्री" },
    ],
    correctAnswer: 0,
  };
  
  const marathiProblem2: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `यापैकी "कुत्रा" कोणता आहे?`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/corgi.png" alt="कुत्रा" />, name: "कुत्रा" },
      { icon: <img src="https://img.icons8.com/color/100/fat-cat.png" alt="मांजर" />, name: "मांजर" },
      { icon: <img src="https://img.icons8.com/color/100/bread.png" alt="ब्रेड" />, name: "ब्रेड" },
    ],
    correctAnswer: 0,
  };
  
  const marathiProblem3: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `यापैकी "गाय" कोणती आहे?`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/cow.png" alt="गाय" />, name: "गाय" },
      { icon: <img src="https://img.icons8.com/color/100/horse.png" alt="घोडा" />, name: "घोडा" },
      { icon: <img src="https://img.icons8.com/color/100/sheep.png" alt="मेंढी" />, name: "मेंढी" },
    ],
    correctAnswer: 0,
  };
  
  const marathiProblem4: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `यापैकी "झाड" कोणते आहे?`,
    answers: [
      { icon: <img src="https://img.icons8.com/doodle/100/tree--v1.png" alt="झाड" />, name: "झाड" },
      { icon: <img src="https://img.icons8.com/color/100/grass.png" alt="गवत" />, name: "गवत" },
      { icon: <img src="https://img.icons8.com/color/100/flower.png" alt="फुल" />, name: "फुल" },
    ],
    correctAnswer: 0,
  };
  
  const marathiProblem5: Select1Of3Problem = {
    type: "SELECT_1_OF_3",
    question: `यापैकी "सूर्य" कोणता आहे?`,
    answers: [
      { icon: <img src="https://img.icons8.com/color/100/sun.png" alt="सूर्य" />, name: "सूर्य" },
      { icon: <img src="https://img.icons8.com/color/100/moon.png" alt="चंद्र" />, name: "चंद्र" },
      { icon: <img src="https://img.icons8.com/color/100/star.png" alt="तारा" />, name: "तारा" },
    ],
    correctAnswer: 0,
  };
  
  // Additional Marathi problems in WRITE_IN_ENGLISH format
  const marathiProblem8: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "तो शाळेत जात आहे", // "He is going to school"
    answerTiles: ["he", "she", "school", "going", "to", "it", "is", "they"],
    correctAnswer: [0, 6, 3, 4, 2],
  };
  
  const marathiProblem9: WriteInEnglishProblem = {
    type: "WRITE_IN_ENGLISH",
    question: "मी अन्न खात आहे", // "I am eating food"
    answerTiles: ["I", "food", "eating", "am", "drink", "we", "you"],
    correctAnswer: [0, 3, 2, 1],
  };
  
  // More problems follow this pattern
  
  const marathiProblems: Basemarathiproblem[] = [
    marathiProblem1,
    marathiProblem2,
    marathiProblem3,
    marathiProblem4,
...
type marathiproblemsArray = readonly (Select1Of3Problem | WriteInEnglishProblem)[];

// Cast the marathiproblem array to the correct type
...
const getRandomQuestions = (problems: Basemarathiproblem[], count: number): Basemarathiproblem[] => {
...
const marathiLessons: NextPage = () => {
    const router = useRouter();
  
    const [marathiproblemIndex, setmarathiproblemIndex] = useState(0); // Renamed to clarify it's an index
    ...
    const [, setSelectedQuestions] = useState<Basemarathiproblem[]>([]);
    ...
    useEffect(() => {
      const questions = getRandomQuestions(marathiProblems, 3); // Get 2 random questions
    ...
    const problem = marathiProblems[marathiproblemIndex] ?? marathiProblem1;
  ...
  const onFinish = () => {
    ...
    setmarathiproblemIndex((x) => (x + 1) % marathiProblems.length);
