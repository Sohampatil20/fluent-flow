...
const handleLanguageChange = (lang: string) => {
  setSelectedLanguage(lang); // Save the selected language in state
};
...
const Register: NextPage = () => {
  ...
  <Link
  key={language.name}
  href={language.name === "Hindi" ? "/learn" : "/learn"} // Change href for Hindi
  className={
  ...
  onClick={() => setLanguage(language)} // Keep language setting as is
>
